...
ion_component.spacer = "<div id='page_id-component_id' data-componentid='component_id' class='spacer ic-selected target'style='min-height: 20px;' data-draggable='item'></div>";
ion_component.checkbox = "<label id='page_id-component_id' data-componentid='component_id' class='item item-checkbox ic-selected target'  data-draggable='item'><div class='checkbox'><label><input type='checkbox' value=''><i class='input-helper'></i>Don't forget to check me out</label></div></label>";
ion_component.form = "";
